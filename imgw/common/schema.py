...
K_D_T_COLUMNS: dict[str, pa.DataType] = {
    ...
    "month": pa.int8(),
    "day": pa.int8(),
    "temp_daily_average": pa.float32(),
    "temp_average_status": pa.string(),
    "humidity_daily_average": pa.float32(),
    "humidity_status": pa.string(),
    "wind_speed_daily_average": pa.float32(),
    "wind_speed_status": pa.string(),
    "cloud_coverage_daily_average": pa.float32(),
...
O_D_COLUMNS: dict[str, pa.DataType] = {
    ...
    "month": pa.int8(),
    "day": pa.int8(),
    "precipitation_daily_total": pa.float32(),  # Suma dobowa opadów [mm]
    "precipitation_daily_total_status": pa.string(),  # Status pomiaru SMDB
    "precipitation_type": pa.string(),  # Rodzaj opadu [S/W/ ]
    "snow_cover_height": pa.float32(),  # Wysokość pokrywy śnieżnej [cm] - float safer
    "snow_cover_height_status": pa.string(),  # Status pomiaru PKSN
    "fresh_snow_height": pa.float32(),  # Wysokość świeżospałego śniegu [cm] - float safer
...
S_D_COLUMNS: dict[str, pa.DataType] = {
    ...
    "precipitation_type": pa.string(),
    "snow_coverage_height": pa.float32(),  # Assuming float is safer even if width is 5
    "snow_coverage_height_status": pa.string(),  # Adjusted name based on PKSN
    "snow_water_equivalent": pa.float32(),
    "snow_water_equivalent_status": pa.string(),
    "sunshine_duration": pa.float32(),
    "sunshine_duration_status": pa.string(),
    "duration_rain": pa.float32(),
    "duration_rain_status": pa.string(),
    "duration_snow": pa.float32(),
    "duration_snow_status": pa.string(),
    "duration_sleet": pa.float32(),  # Deszcz ze śniegiem = Sleet/Rain and snow
    "duration_sleet_status": pa.string(),
    "duration_hail": pa.float32(),
    "duration_hail_status": pa.string(),
    "duration_fog": pa.float32(),
    "duration_fog_status": pa.string(),
    "duration_mist": pa.float32(),  # Zamglenie = Mist
    "duration_mist_status": pa.string(),
    "duration_rime": pa.float32(),  # Sadź = Rime
    "duration_rime_status": pa.string(),
    "duration_glaze": pa.float32(),  # Gołoledź = Glaze ice
    "duration_glaze_status": pa.string(),
    "duration_low_drifting_snow": pa.float32(),  # Zamieć śnieżna niska = Low drifting snow
    "duration_low_drifting_snow_status": pa.string(),
    "duration_high_drifting_snow": pa.float32(),  # Zamieć śnieżna wysoka = High drifting snow
    "duration_high_drifting_snow_status": pa.string(),
    "duration_haze": pa.float32(),  # Zmętnienie = Haze/Turbidity
    "duration_haze_status": pa.string(),
    "duration_wind_gte_10mps": pa.float32(),  # Wiatr >= 10m/s
    "duration_wind_gte_10mps_status": pa.string(),
    "duration_wind_gt_15mps": pa.float32(),  # Wiatr > 15m/s
    "duration_wind_gt_15mps_status": pa.string(),
    "duration_thunderstorm": pa.float32(),  # Burza = Thunderstorm
    "duration_thunderstorm_status": pa.string(),
    "duration_dew": pa.float32(),  # Rosa = Dew
    "duration_dew_status": pa.string(),
    "duration_frost": pa.float32(),  # Szron = Frost
    "duration_frost_status": pa.string(),
    "occurrence_snow_cover": pa.int8(),  # Wystąpienie pokrywy śnieżnej [0/1]
    "occurrence_snow_cover_status": pa.string(),
    "occurrence_lightning": pa.int8(),  # Wystąpienie błyskawicy [0/1]
    "occurrence_lightning_status": pa.string(),
    "ground_state": pa.string(),  # Stan gruntu [Z/R] - Frozen/Thawed? Assuming string
    "isotherm_lower": pa.float32(),  # Izoterma dolna [cm]
    "isotherm_lower_status": pa.string(),
    "isotherm_upper": pa.float32(),  # Izoterma górna [cm]
    "isotherm_upper_status": pa.string(),
    "actinometry": pa.float32(),  # Aktynometria [J/cm2]
...
S_D_T_COLUMNS: dict[str, pa.DataType] = {
    ...
    "month": pa.int8(),
    "day": pa.int8(),
    "average_daily_cloud_cover": pa.float32(),  # Zachmurzenie ogólne [oktanty]
    "cloud_cover_status": pa.string(),  # Status pomiaru NOS
    "average_daily_wind_speed": pa.float32(),  # Prędkość wiatru [m/s]
    "wind_speed_status": pa.string(),  # Status pomiaru FWS
    "temp_daily_average": pa.float32(),  # Temperatura [°C] (Assuming same as previous schema's average)
    "temp_daily_average_status": pa.string(),  # Status pomiaru TEMP
    "average_daily_vapor_pressure": pa.float32(),  # Ciśnienie pary wodnej [hPa]
    "vapor_pressure_status": pa.string(),  # Status pomiaru CPW
    "average_daily_relative_humidity": pa.float32(),  # Wilgotność względna [%]
    "relative_humidity_status": pa.string(),  # Status pomiaru WLGS
    "average_daily_station_pressure": pa.float32(),  # Ciśnienie na poziomie stacji [hPa]
    "station_pressure_status": pa.string(),  # Status pomiaru PPPS
    "average_daily_sea_level_pressure": pa.float32(),  # Ciśnienie na poziomie morza [hPa]
    "sea_level_pressure_status": pa.string(),  # Status pomiaru PPPM
    "precipitation_sum_day": pa.float32(),  # Suma opadu dzień [mm]
    "precipitation_sum_day_status": pa.string(),  # Status pomiaru WODZ
    "precipitation_sum_night": pa.float32(),  # Suma opadu noc [mm]
...
K_T_COLUMNS: dict[str, pa.DataType] = {
    ...
    "month": pa.int8(),
    "day": pa.int8(),
    "hour": pa.int8(),  # Godzina
    "air_temperature": pa.float32(),  # Temperatura powietrza [°C]
    "air_temperature_status": pa.string(),  # Status pomiaru TEMP
    "wet_bulb_temperature": pa.float32(),  # Temperatura termometru zwilżonego [°C]
    ...
    "relative_humidity": pa.float32(),  # Wilgotność względna [%] - Width 5 suggests potential decimals or 100.0
    ...
    "wind_speed": pa.float32(),  # Prędkość wiatru [m/s] - Width 5 allows for decimals
    "wind_speed_status": pa.string(),  # Status pomiaru FWR
    "cloud_cover_general": pa.float32(),  # Zachmurzenie ogólne [oktanty] - Oktants usually int, but float safer
...
S_T_COLUMNS: dict[str, pa.DataType] = {
    ...
    "cloud_base_lower_m": pa.float32(),  # Wysokość podstawy niższej [m]
    "cloud_base_lower_m_status": pa.string(),  # Status pomiaru HPON
    "cloud_base_upper_m": pa.float32(),  # Wysokość podstawy wyższej [m]
    ...
    "visibility_code_status": pa.string(),  # Status pomiaru WID
    "visibility_operator_m": pa.float32(),  # Widzialność operatora [m]
    "visibility_operator_m_status": pa.string(),  # Status pomiaru WIDO
    "visibility_auto_m": pa.float32(),  # Widzialność automat [m]
    ...
    "wind_direction_deg": pa.float32(),  # Kierunek wiatru [°]
    "wind_direction_deg_status": pa.string(),  # Status pomiaru KRWR
    "wind_speed_ms": pa.float32(),  # Prędkość wiatru [m/s]
    "wind_speed_ms_status": pa.string(),  # Status pomiaru FWR
    "wind_gust_ms": pa.float32(),  # Poryw wiatru [m/s]
    "wind_gust_ms_status": pa.string(),  # Status pomiaru PORW
    "air_temperature_c": pa.float32(),  # Temperatura powietrza [°C]
    "air_temperature_c_status": pa.string(),  # Status pomiaru TEMP
    "wet_bulb_temperature_c": pa.float32(),  # Temperatura termometru zwilżonego [°C]
    ...
    "vapor_pressure_hpa": pa.float32(),  # Ciśnienie pary wodnej [hPa]
    "vapor_pressure_hpa_status": pa.string(),  # Status pomiaru CPW
    "relative_humidity_percent": pa.float32(),  # Wilgotność względna [%]
    "relative_humidity_percent_status": pa.string(),  # Status pomiaru WLGW
    "dew_point_temperature_c": pa.float32(),  # Temperatura punktu rosy [°C]
    "dew_point_temperature_c_status": pa.string(),  # Status pomiaru TPTR
    "station_pressure_hpa": pa.float32(),  # Ciśnienie na pozimie stacji [hPa]
    "station_pressure_hpa_status": pa.string(),  # Status pomiaru PPPS
    "sea_level_pressure_hpa": pa.float32(),  # Ciśnienie na pozimie morza [hPa]
    ...
    "pressure_tendency_value": pa.float32(),  # Wartość tendencji [wartość]
    "pressure_tendency_status": pa.string(),  # Status pomiaru APP
    "precipitation_6hr_mm": pa.float32(),  # Opad za 6 godzin [mm]
    ...
    "humidity_deficit_hpa": pa.float32(),  # Niedosyt wilgotności [hPa]
    "humidity_deficit_hpa_status": pa.string(),  # Status pomiaru DEFI
    "sunshine_duration": pa.float32(),  # Usłonecznienie
    "sunshine_duration_status": pa.string(),  # Status pomiaru USLN
    "dew_occurrence_flag": pa.int8(),  # Wystąpienie rosy [0/1]
    "dew_occurrence_flag_status": pa.string(),  # Status pomiaru ROSW
    "max_gust_ww_period_ms": pa.float32(),  # Poryw maksymalny za okres WW [m/s]
    "max_gust_ww_period_ms_status": pa.string(),  # Status pomiaru PORK
    "max_gust_hour": pa.int8(),  # Godzina wystąpienia porywu
    "max_gust_minute": pa.int8(),  # Minuta wystąpienia porywu
    "ground_temp_5cm_c": pa.float32(),  # Temperatura gruntu -5 [°C]
    "ground_temp_5cm_c_status": pa.string(),  # Status pomiaru TG05
    "ground_temp_10cm_c": pa.float32(),  # Temperatura gruntu -10 [°C]
    "ground_temp_10cm_c_status": pa.string(),  # Status pomiaru TG10
    "ground_temp_20cm_c": pa.float32(),  # Temperatura gruntu -20 [°C]
    "ground_temp_20cm_c_status": pa.string(),  # Status pomiaru TG20
    "ground_temp_50cm_c": pa.float32(),  # Temperatura gruntu -50 [°C]
    "ground_temp_50cm_c_status": pa.string(),  # Status pomiaru TG50
    "ground_temp_100cm_c": pa.float32(),  # Temperatura gruntu -100 [°C]
    "ground_temp_100cm_c_status": pa.string(),  # Status pomiaru TG100
    "temp_min_12hr_c": pa.float32(),  # Temperatura minimalna za 12 godzin [°C]
    "temp_min_12hr_c_status": pa.string(),  # Status pomiaru TMIN
    "temp_max_12hr_c": pa.float32(),  # Temperatura maksymalna za 12 godzin [°C]
    "temp_max_12hr_c_status": pa.string(),  # Status pomiaru TMAX
    "ground_temp_min_12hr_c": pa.float32(),  # Temperatura minimalna przy gruncie za 12 godzin [°C]
    "ground_temp_min_12hr_c_status": pa.string(),  # Status pomiaru TGMI
    "snow_water_equivalent_mm_cm": pa.float32(),  # Równoważnik wodny śniegu [mm/cm]
    "snow_water_equivalent_mm_cm_status": pa.string(),  # Status pomiaru RWSN
    "snow_cover_height_cm": pa.float32(),  # Wysokość pokrywy śnieżnej [cm]
    "snow_cover_height_cm_status": pa.string(),  # Status pomiaru PKSN
    "fresh_snow_height_cm": pa.float32(),  # Wysokość świeżo spadłego śniegu [cm]
    "fresh_snow_height_cm_status": pa.string(),  # Status pomiaru HSS
    "snow_height_plot_cm": pa.float32(),  # Wysokość śniegu na poletku [cm]
    "snow_height_plot_cm_status": pa.string(),  # Status pomiaru GRSN
    "snow_type_code": pa.string(),  # Gatunek śniegu [kod]
    "snow_cover_formation_code": pa.string(),  # Ukształtowanie pokrywy [kod]
    "snow_sample_height_cm": pa.float32(),  # Wysokość próbki [cm]
    "snow_sample_height_cm_status": pa.string(),  # Status pomiaru HPRO
    "snow_water_storage_mm": pa.float32(),  # Zapas wody w śniegu [mm]
